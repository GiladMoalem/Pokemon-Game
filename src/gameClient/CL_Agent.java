...
public class CL_Agent {
	...
	//	private long _key;
		...
		private long _sg_dt;
		private edge_data nextPokemonEdge; //the edge of the next pokemon this agent is going to
		...
		public void setMoney(double v) {_value = v;}//private -> public //i added
		...
		public boolean setNextNode(int dest) {
			...
			else {_curr_edge = null;}//unnecessary
			return ans;
		}
		...
		public edge_data getNextPokemonEdge(){
			return this.nextPokemonEdge;
		}
		public void setNextPokemonEdge(edge_data nextEdge){
			this.nextPokemonEdge = nextEdge;
		}
	}
